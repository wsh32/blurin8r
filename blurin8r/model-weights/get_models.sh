...
TINY_FILENAME=face-yolov3-tiny_41000.weights
...
wget --load-cookies /tmp/cookies.txt -r "https://docs.google.com/uc?export=download&confirm=$(wget --quiet --save-cookies /tmp/cookies.txt --keep-session-cookies --no-check-certificate 'https://docs.google.com/uc?export=download&id=1xG0QhxwWtyB17PKfifxHV9FPSck2z1Bk' -O- | sed -rn 's/.*confirm=([0-9A-Za-z_]+).*/\1\n/p')&id=1xG0QhxwWtyB17PKfifxHV9FPSck2z1Bk" -O $TINY_FILENAME && rm -rf /tmp/cookies.txt
